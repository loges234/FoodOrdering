                      ...
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            ...
                            <td>
							<button type='button' class='btn btn-info btn-sm btn-flat transact' data-id='".$row['salesid']."'><i class='fa fa-search'></i> View Detail</button>
						    <button type='button' class='btn btn-danger btn-sm btn-flat delete' data-id='".$row['salesid']."'><i class='fa fa-trash'></i> Cancel Order</button>
							</td>

	        	...
	        	<div class="col-sm-9">
	        				...
	        				<div class="col-sm-9">
	        					<div class="row">
	        						...
	        						<div class="col-sm-9">
										...
										<h4><?php echo (!empty($user['bodyInfo'])) ? $user['bodyInfo'] : 'N/a'; ?></h4>
	        		...
	        		<div class="box box-solid">
	        			<div class="box-header with-border">
	        				<h4 class="box-title"><i class="fa fa-calendar"></i> <b>Transaction History - Cancelled order automatically removed from the list.</b></h4>
	        			</div>
	        			<div class="box-body">

    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Transaction Order Details</b></h4>
            </div>
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_edit.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
				  ...
				  <div class="form-group">
                    <label for="address" class="col-sm-3 control-label">Remark</label>

                    <div class="col-sm-9">
                      <textarea class="form-control" id="bodyInfo" name="bodyInfo"><?php echo $user['bodyInfo']; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
